...
<body>
		...
		<nav class="navbar navbar-default" role="navigation"> <div class="navbar-header"> <a class="navbar-brand" href="#">Accueil</a> </div> <div id="myexample"> <ul class="nav navbar-nav"> <li class="active"><a href="#">Historique</a></li> <li><a href="#">Activités</a></li><li><a href="#">Espace</a></li><li><a href="#">Forum</a></li><li><a href="#">Contact</a></li> <li class="dropdown"> <a href="#" class="dropdown-toggle">Espace77<b class="caret"></b></a> <ul class="dropdown-menu"> <li><a id="action-1" href="#"> jmeter</a> </li> <li><a href="#">EJB</a></li> <li><a href="#">Jasper Report</a></li> <li class="divider"></li> <li><a href="#">Separated link</a></li> <li class="divider"></li> <li><a href="#">One more separated link</a></li> </ul> </li> </ul> </div> </nav></div>	
		
	   <div class="container" style="background-color:#00FFFF; margin-top:-20px">jhjjjfgf
	   <img class="img-responsive" src="image/Baguette 02.png" />
	   </div>																																											
</body>
